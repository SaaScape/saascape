...
const InstanceOverview = ({ instance, application, setInstance }: IProps) => {
          ...
          <div className='grid-child'>
            <div>
              ...
              <div className='d-flex align-center justify-between'>
                <span>
                  {swarm?.name || instance?.swarm_id?.toString() || "None"}
                </span>
